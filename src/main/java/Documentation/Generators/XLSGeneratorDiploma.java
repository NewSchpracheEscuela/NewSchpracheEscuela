 ...
 */
public class XLSGeneratorDiploma implements IGenerator<BlankInfo> {
    ...
    private void addContent(List<BlankInfo> model, Sheet sheet, CellStyle style) {
        ...
        Row description2 = sheet.createRow(2);
        Row rowFIO = sheet.createRow(3);
        Row rowCourse = sheet.createRow(4);
        Row rowDate = sheet.createRow(5);

        header.createCell(0).setCellValue("Диплом");
        header.createCell(1);

        description1.createCell(0).setCellValue("об окончании");
        description1.createCell(1);

        description2.createCell(0).setCellValue("награждается");
        description2.createCell(1);
        ...
        rowCourse.createCell(1).setCellValue(item.getCourseTitle());

        rowDate.createCell(0).setCellValue("Дата");
        rowDate.createCell(1).setCellValue(getCurrentDate());
